...
<html>
    ...
    <body>
        ...
        <div id="search" class="form-group">
            <label type="text" size="20" class="form-control"/><b id="conid">浙江省杭州市拱墅区丰潭路380号</b><a href="javascript:;" class="btn" style="padding: 0">->立即前往</a></label>
        </div>
...
<script type="text/javascript">
    ...
    document.querySelector(".btn").onclick = function (e) {
        ...
        if (browser.versions.ios) {
            window.location.href = 'http://maps.apple.com/?daddr=' + myValue + '&dirflg=d&t=m';//苹果地图
        } else if (browser.versions.android) {
            openApp("bdapp://map/direction?origin=我的位置&destination=" + myValue + "&mode=driving");
        }
    };
